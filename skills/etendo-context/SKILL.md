...
First, read `~/.config/opencode/skills/etendo-_shared/guidelines.md` and `~/.config/opencode/skills/etendo-_shared/context.md` to understand how context resolution works.

For infrastructure modes (Source vs JAR, Docker flags, DB connection), read `~/.config/opencode/skills/etendo-_shared/references/infrastructure-modes.md`.
