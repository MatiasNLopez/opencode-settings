...
First, read `~/.config/opencode/skills/etendo-_shared/guidelines.md` and `~/.config/opencode/skills/etendo-_shared/context.md` to resolve the active module and DB connection.

For the full EtendoRX API reference and endpoint configuration, read `~/.config/opencode/skills/etendo-_shared/references/etendo-headless.md`.
For the complete data model and SQL templates, read `~/.config/opencode/skills/etendo-_shared/references/headless-flow-guide.md`.
...
See `~/.config/opencode/skills/etendo-_shared/references/headless-flow-guide.md` "Adding a Webhook endpoint to a flow" section for the full SQL template.
