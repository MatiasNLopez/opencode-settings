...
For infrastructure modes (Source vs JAR, Docker flags), read `~/.config/opencode/skills/etendo-_shared/references/infrastructure-modes.md`. For Gradle task details, read `~/.config/opencode/skills/etendo-_shared/references/gradle-tasks-reference.md`.
