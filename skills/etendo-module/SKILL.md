...
For AD XML structure (AD_MODULE, AD_MODULE_DBPREFIX), read `~/.config/opencode/skills/etendo-_shared/references/application-dictionary.md`. For publishing to Nexus, read `~/.config/opencode/skills/etendo-_shared/references/module-publishing.md`.
