...
For complete testing patterns, base classes, and Mockito recipes, read `~/.config/opencode/skills/etendo-_shared/references/testing-guide.md`.

For DAL patterns, entity structure, and module layout, read `~/.config/opencode/skills/etendo-_shared/references/java-development.md`.
...
Follow this decision tree (detailed in `~/.config/opencode/skills/etendo-_shared/references/testing-guide.md` Section 15):
...
Use the appropriate template from `~/.config/opencode/skills/etendo-_shared/references/testing-guide.md`:
