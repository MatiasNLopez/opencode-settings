...
For AD XML structure and window/tab/field patterns, read `~/.config/opencode/skills/etendo-_shared/references/application-dictionary.md`. For display logic, references, and field-level configuration, read `~/.config/opencode/skills/etendo-_shared/references/advanced-ad.md`.
